        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-8 items-center">
              <li className="text-gray-600 hover:text-orange-500 font-medium transition-colors cursor-pointer">
                Home
              </li>
              <li className="text-gray-600 hover:text-orange-500 font-medium transition-colors cursor-pointer">
                About Us
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
                className="bg-gray-900 hover:bg-gray-800 text-white px-5 py-2.5 rounded-full font-medium transition-all transform hover:scale-105 active:scale-95 shadow-md cursor-pointer"
                onClick={() => 
                    setLogin(!login)
                }
            >
