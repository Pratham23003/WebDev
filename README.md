...
| Sept 12 | Projects Live | Made all projects live.|
| Sept 13 | JS Project | Wrote HTML & CSS for a basic form validation project.|
---
...
| Color Changer | A basic, beginner-friendly JavaScript project that changes the page background color when you click one of the colored boxes. | [Live](https://pratham23003.github.io/color-changer-JS/) | [Repo](https://github.com/Pratham23003/color-changer-JS) |
| Bmi Calculator | A simple, responsive Body Mass Index (BMI) calculator built with vanilla HTML, CSS, and JavaScript as a learning project. | [Live](https://pratham23003.github.io/bmi-calculator-JS/) | [Repo](https://github.com/Pratham23003/bmi-calculator-JS) |
| Digital Clock | A simple, retro-styled digital clock built with vanilla JavaScript, HTML, and CSS. | [Live](https://pratham23003.github.io/digital-clock-JS/) | [Repo](https://github.com/Pratham23003/digital-clock-JS) |
| Guess the Number | A simple and interactive number guessing game built with vanilla JavaScript, HTML, and CSS. | [Live](https://pratham23003.github.io/guess-the-number-JS/) | [Repo](https://github.com/Pratham23003/guess-the-number-JS) |
| Color Palette Generator | A simple web app that can generate random color palettes and on clicking the colour container, it copies the color hex to clipboard. | [Live](https://pratham23003.github.io/color-palette-generator-JS/) | [Repo](https://github.com/Pratham23003/color-palette-generator-JS) |
| Simple Kanban Board | A minimal Kanban board built with vanilla HTML, CSS, and JavaScript demonstrating the use of HTML Drag and Drop API to move tasks between columns. | [Live](https://pratham23003.github.io/simple-kanban-board-JS/) | [Repo](https://github.com/Pratham23003/simple-kanban-board-JS) |
| Expense Tracker | A single‑page Expense Tracker. | [Live](https://pratham23003.github.io/Expense-Tracker-JS/) | [Repo](https://github.com/Pratham23003/Expense-Tracker-JS) |
| Bookmark Saver | A web app to save and manage your website bookmarks. | [Live](https://pratham23003.github.io/Bookmark-Saver-JS/) | [Repo](https://github.com/Pratham23003/Bookmark-Saver-JS) |
---
